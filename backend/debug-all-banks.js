// debug-all-banks.js - Debug scraper for all banks
const puppeteer = require('puppeteer');

const banks = [
  { 
    name: 'ANZ', 
    url: 'https://www.anz.co.nz/personal/home-loans-mortgages/loan-types/rates/' 
  },
  { 
    name: 'Kiwibank', 
    url: 'https://www.kiwibank.co.nz/personal-banking/home-loans/rates-and-fees/' 
  },
  { 
    name: 'BNZ', 
  ...
  { 
    name: 'ASB', 
    url: 'https://www.asb.co.nz/home-loans-mortgages/interest-rates-fees.html' 
  },
  { 
    name: 'Westpac', 
    ...
    const tableData = await page.evaluate(() => {
      ...
      tables.forEach((table, tableIndex) => {
        ...
        if (tableRows.length > 0) {
          allTableData.push({
            tableIndex,
            rows: tableRows.slice(0, 15) // First 15 rows
          });
        }
      });
...
const debugAllBanks = async () => {
  console.log('🔍 Debugging all bank websites...\n');
...
debugAllBanks().catch(console.error);